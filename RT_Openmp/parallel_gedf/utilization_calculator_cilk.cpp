...
int main(int argc, char *argv[])
{
	...
	//SG: Commented out OpenMP settings
	/*
	omp_set_dynamic(0);
	omp_set_nested(0);
	...
	*/
        ...
        //Must convert the core range to char because __cilkrts_set_param(const char*, const char*)             
...
//std::cout << runtime_test<<" "<<min_test<<" "<<max_test << std::endl;
	}
	...
	std::string ss0 = "results/execution_time_cilk_"+ss.str()+".dat";
