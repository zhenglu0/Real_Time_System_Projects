...
// System-wide constants. Values in this file may eventually become discovered
// rather than specified.

#ifndef _RTOMP_CONSTANTS_H_
#define _RTOMP_CONSTANTS_H_

//What scheduler type we request
#define LINUX_RT_SCHED SCHED_FIFO 

const unsigned RTOMP_NUM_CPUS = 48; // Should be the total number of CPUs in the
                                    // system, not merely the number of CPUs we 
                                    // wish to use
...
#endif //define _RTOMP_CONSTANTS_H_
