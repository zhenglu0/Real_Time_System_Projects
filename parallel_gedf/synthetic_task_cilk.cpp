//SG
//#include <omp.h>
//SG: Included files needed for Cilk Plus 
#include <cilk.h>
#include <sstream>
#include <stdio.h>
#include "task.h"
...
int init(int argc, char *argv[])
{
	...
	cilk_for (int j = 0; j < iterations; ++j)
	{
...
int run(int argc, char *argv[])
{
	...
	for (i = 0; i < num_segments; ++i)
	{
		...
		//SG: Commented out OpenMP code
		//#pragma omp parallel for schedule(runtime)
		//SG: Added Cilk Plus for loop
